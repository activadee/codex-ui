...
- [x] **Introduce EventBus shell**
  ...
  - Reference: `docs/frontend-architecture.md`.
- [x] **Create Zustand store factory**
...
- [x] **Implement threads slice**
  ...
  - Reference: `docs/frontend-architecture.md`.
- [x] **Implement conversation slice**
  ...
  - Reference: `docs/frontend-architecture.md`.
- [x] **Implement streams slice + agent stream actions**
  ...
  - Reference: `docs/frontend-architecture.md`.
- [x] **Remove React Query + finalize wiring**
